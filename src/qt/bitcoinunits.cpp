...
#include "util.h" // for COIN and FormatMoney
...
mpq BitcoinUnits::maxAmount(int unit)
{
    switch(unit)
    {
    case BTC:  return mpq("21000000/1");
    case mBTC: return mpq("21000000000/1");
    case uBTC: return mpq("21000000000000/1");
    default:   return mpq(0);
    }
}
