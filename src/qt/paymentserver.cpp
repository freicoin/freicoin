...
const char* FREICOIN_REQUEST_MIMETYPE = "application/freicoin-paymentrequest";
const char* FREICOIN_PAYMENTACK_MIMETYPE = "application/freicoin-paymentack";
const char* FREICOIN_PAYMENTACK_CONTENTTYPE = "application/freicoin-payment";
    ...
    if (s.startsWith(FREICOIN_IPC_PREFIX, Qt::CaseInsensitive)) // freicoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseFreicoinURI(s, &recipient))
                ...
                emit message(tr("URI handling"),
                    tr("URI can not be parsed! This can be caused by an invalid Freicoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
...
void PaymentServer::fetchRequest(const QUrl& url)
{
    ...
    netRequest.setRawHeader("Accept", FREICOIN_REQUEST_MIMETYPE);
...
void PaymentServer::fetchPaymentACK(CWallet* wallet, SendCoinsRecipient recipient, QByteArray transaction)
{
    ...
    netRequest.setHeader(QNetworkRequest::ContentTypeHeader, FREICOIN_PAYMENTACK_CONTENTTYPE);
    netRequest.setRawHeader("User-Agent", CLIENT_NAME.c_str());
    netRequest.setRawHeader("Accept", FREICOIN_PAYMENTACK_MIMETYPE);
