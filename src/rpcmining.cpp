...
Value getblocktemplate(const Array& params, bool fHelp)
{
    ...
    BOOST_FOREACH (CTransaction& tx, pblock->vtx)
    {
        ...
        entry.push_back(Pair("fee", pblocktemplate->vTxFees[index_in_template].ToValue()));
    ...
    result.push_back(Pair("coinbasevalue", (int64_t)pblock->vtx[0].vout[0].nValue.ToValue()));
