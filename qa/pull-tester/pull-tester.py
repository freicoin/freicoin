...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old FreicoinPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/FreicoindComparisonTool_jar/FreicoindComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/freicoin/freicoin.git")
...
environ_default("BUILD_PATH", "/mnt/freicoin")
...
environ_default("GITHUB_REPO", "freicoin/freicoin")
