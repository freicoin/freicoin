...
SIGNATUREFILE="http://downloads.sourceforge.net/project/freicoin/Freicoin/freicoin-0.9.0rc1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/freicoin/Freicoin/"
...
if [ $? -ne 0 ]; then
   ...
   echo "[freicoin-]<version>-[rc[0-9]] (example: freicoin-0.7.1-rc1)"
   echo "wget output:"
