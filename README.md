https://us-east-1.console.aws.amazon.com/billing/home?region=us-east-1&skipRegion=true#/paymentmethods
...
'"Process finished with OPEN("exit(1(TRUE()))":,
Footer
© 2023 GitHub, Inc.
Footer navigation
Terms
...
https://us-east-1.console.aws.amazon.com/billing/home?region=us-east-1&skipRegion=true#/paymentmethods+'require'/ ':'' 'test'' :
+  '- '.devcontainer/**'
